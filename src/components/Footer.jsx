      ...
      <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between">
        <div>
          ...
          <p className="text-gray-400">
            30-minute fashion delivery service in Hyderabad.
          </p>
        </div>
        <div className="mt-8 md:mt-0 flex flex-col gap-2 transition duration-300">
          ...
          <a href="/survey" className="hover:text-[#f3423a]">
            Survey
          </a>
        </div>
        <div className="mt-8 md:mt-0">
          ...
          <div className="flex space-x-4">
            <a
              href="https://www.instagram.com/flashfit.in/?igsh=ZHprd3c3Zmxucndj#"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-[#f3423a] transition duration-300"
            >
              Instagram
            </a>
          </div>
